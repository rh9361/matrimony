...
class Profileregister(forms.ModelForm):
    class Meta:
        model = profiles
        fields = [
            "name","gender","email", "mobile_no", "dateOfBirth","maritalStatus","religion","image"
        ]
...
class Profileupdate(forms.ModelForm):
    class Meta:
        model = profiles
        fields = [
            "maritalStatus", "height", "image", "image2", "image3", "image4", "body_Type", "weight", "drink", "smoke", "motherTongue", "blood_group",
